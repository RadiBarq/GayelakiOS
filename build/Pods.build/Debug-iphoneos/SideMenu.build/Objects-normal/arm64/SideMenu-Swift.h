...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum MenuPushStyle menuPushStyle SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuPushStyle");)
+ (enum MenuPushStyle)menuPushStyle SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuPushStyle:(enum MenuPushStyle)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum MenuPresentMode menuPresentMode SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuPresentMode");)
+ (enum MenuPresentMode)menuPresentMode SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuPresentMode:(enum MenuPresentMode)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL menuAllowPushOfSameClassTwice SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAllowPushOfSameClassTwice");)
+ (BOOL)menuAllowPushOfSameClassTwice SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuAllowPushOfSameClassTwice:(BOOL)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) CGFloat menuWidth SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuWidth");)
+ (CGFloat)menuWidth SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuWidth:(CGFloat)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) double menuAnimationPresentDuration SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationPresentDuration");)
+ (double)menuAnimationPresentDuration SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuAnimationPresentDuration:(double)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) double menuAnimationDismissDuration SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationDismissDuration");)
+ (double)menuAnimationDismissDuration SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuAnimationDismissDuration:(double)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) double menuAnimationCompleteGestureDuration SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationCompleteGestureDuration");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) CGFloat menuAnimationFadeStrength SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationFadeStrength");)
+ (CGFloat)menuAnimationFadeStrength SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuAnimationFadeStrength:(CGFloat)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) CGFloat menuAnimationTransformScaleFactor SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationTransformScaleFactor");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nullable menuAnimationBackgroundColor SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationBackgroundColor");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) float menuShadowOpacity SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuShadowOpacity");)
+ (float)menuShadowOpacity SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuShadowOpacity:(float)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull menuShadowColor SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuShadowColor");)
+ (UIColor * _Nonnull)menuShadowColor SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuShadowColor:(UIColor * _Nonnull)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) CGFloat menuShadowRadius SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuShadowRadius");)
+ (CGFloat)menuShadowRadius SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuShadowRadius:(CGFloat)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL menuPresentingViewControllerUserInteractionEnabled SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuPresentingViewControllerUserInteractionEnabled");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger menuParallaxStrength SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuParallaxStrength");)
+ (NSInteger)menuParallaxStrength SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuParallaxStrength:(NSInteger)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL menuFadeStatusBar SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuFadeStatusBar");)
+ (BOOL)menuFadeStatusBar SWIFT_WARN_UNUSED_RESULT;
+ (void)setMenuFadeStatusBar:(BOOL)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) UIViewAnimationOptions menuAnimationOptions SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationOptions");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) CGFloat menuAnimationUsingSpringWithDamping SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationUsingSpringWithDamping");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) CGFloat menuAnimationInitialSpringVelocity SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuAnimationInitialSpringVelocity");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL menuDismissOnPush SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuDismissOnPush");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UISideMenuNavigationController * _Nullable menuLeftNavigationController SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuLeftNavigationController");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UISideMenuNavigationController * _Nullable menuRightNavigationController SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuRightNavigationController");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, weak) UIPanGestureRecognizer * _Nullable menuLeftSwipeToDismissGesture SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuLeftSwipeToDismissGesture");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, weak) UIPanGestureRecognizer * _Nullable menuRightSwipeToDismissGesture SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuRightSwipeToDismissGesture");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL menuEnableSwipeGestures SWIFT_DEPRECATED_MSG("SideMenuManager class methods deprecated.", "default.menuEnableSwipeGestures");)
...
- (nonnull instancetype)initWithSideMenuManager:(SideMenuManager * _Nonnull)sideMenuManager OBJC_DESIGNATED_INITIALIZER;
