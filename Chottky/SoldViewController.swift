...
class SoldViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        {
            databaseRef = Database.database().reference().child("Users").child(userID).child("sold_items")
        }
            
        else
        {
            databaseRef = Database.database().reference().child("Users").child(ProfileViewController.userId).child("sold_items")
        }
