...
class SellingViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        {
            databaseRef = Database.database().reference().child("Users").child(userID).child("items")
        }
        
        else
        {
            databaseRef = Database.database().reference().child("Users").child(ProfileViewController.userId).child("items")
        }
